...
client.load = function load (serverSettings, callback) {
  ...
  // this would happen if the user is alread logged in
  ...
  // This is performed after the Authentication Check
  ...
  // start the authentication, verifiying if tokens stored locally else
